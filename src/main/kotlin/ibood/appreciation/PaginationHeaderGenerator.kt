...
object PaginationHeaderGenerator {
    ...
    private const val totalCountHeader = "$prefix.totalCount"
    private const val pageSizeHeader = "$prefix.pageSize"
    private const val currentPageHeader = "$prefix.currentPage"
    private const val nextPageHeader = "$prefix.nextPage"
    private const val nextPageUrlHeader = "$prefix.nextPageUrl"
    private const val previousPageHeader = "$prefix.previousPage"
    private const val previousPageUrlHeader = "$prefix.previousPageUrl"
    ...
    private fun buildHeadersForPagedDataSet(total: Int,
        ...
        val currentPageNumber = 1 + ceil(offset / limit.toDouble()).toInt()
